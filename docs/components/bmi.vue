<template>
  <div class="p-4 bmi-calculator dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="relative mb-6" style="min-height: 260px;">
      <!-- 结果展示区域 -->
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transform transition-all duration-500 absolute top-0 left-0 right-0 w-full overflow-hidden"
           :class="{'scale-100 opacity-100 z-10': bmi, 'scale-95 opacity-0 z-0': !bmi}">
        <!-- 装饰元素 -->
        <div class="absolute -right-10 -top-10 w-32 h-32 bg-green-100 dark:bg-green-900/30 rounded-full opacity-50"></div>
        <div class="absolute -left-10 -bottom-10 w-24 h-24 bg-blue-100 dark:bg-blue-900/30 rounded-full opacity-50"></div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transform transition-all duration-500 absolute top-0 left-0 right-0 w-full overflow-hidden"
        ...
        <div class="absolute -left-10 -bottom-10 w-24 h-24 bg-green-100 dark:bg-green-900/30 rounded-full opacity-50"></div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 relative overflow-hidden">
      ...
      <form @submit.prevent="formSubmit" class="space-y-6 relative z-10">
        ...
        <button
          ...
          :class="{'opacity-70 cursor-not-allowed': !height || !weight}"
        >
