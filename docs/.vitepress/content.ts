...
export const integrations: Integration[] = [
  ...
  },
  {
    name: "Svelte",
    secondary: "(Scoped)",
    link: "/integrations/svelte-scoped",
...
export const examples: Example[] = [
  ...
  },
  {
    ...
    icons: ["i-logos-vitejs", "i-logos-solidjs-icon"],
    stackblitz: true,
  },
  {
    name: "astro-vue",
    path: "examples/astro-vue",
    icons: ["i-logos-astro-icon dark:invert", "i-logos-vue"],
    stackblitz: true,
  },
  {
    name: "qwik",
  ...
  },
  {
    ...
    icons: ["i-logos-vitejs", "i-logos-elm"],
    // stackblitz: true,
  },
  {
    name: "vite-svelte",
    path: "examples/vite-svelte",
    icons: ["i-logos-vitejs", "i-logos-svelte-icon"],
    stackblitz: true,
  },
  {
    name: "next",
  ...
  },
  {
    ...
    icons: ["i-logos-vitejs", "i-ph-lightning text-yellow"],
  ...
  },
  {
    ...
    icons: ["i-logos-vitejs", "i-logos-lit-icon"],
    stackblitz: true,
  },
  {
    name: "vite-svelte-postcss",
    path: "examples/vite-svelte-postcss",
    icons: ["i-logos-postcss", "i-logos-svelte-icon"],
    stackblitz: true,
  },
  {
    name: "remix",
  ...
  },
  {
    ...
    icons: ["i-logos-vitejs", "i-logos-preact"],
    stackblitz: true,
  },
  {
    name: "vite-vue3",
    path: "examples/vite-vue3",
    icons: ["i-logos-vitejs", "i-logos-vue"],
    stackblitz: true,
  },
  {
    name: "sveltekit",
  ...
  },
  {
    ...
    icons: ["i-logos-vitejs", "i-logos-pug"],
    stackblitz: true,
  },
  {
    name: "vite-vue3-postcss",
    path: "examples/vite-vue3-postcss",
    icons: ["i-logos-postcss", "i-logos-vue"],
    stackblitz: true,
  },
  {
    name: "nuxt3",
  ...
  },
  {
    ...
    icons: ["i-logos-vitejs", "i-logos-react"],
    stackblitz: true,
  },
  {
    name: "vite-angular",
    path: "examples/vite-angular",
    icons: ["i-logos-vitejs", "i-logos-angular-icon"],
    stackblitz: true,
  },
